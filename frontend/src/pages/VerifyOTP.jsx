          ...
          <div className="bg-surface-container-lowest rounded-xl p-8 md:p-16 soft-ambient-shadow relative overflow-hidden">
            ...
            <header className="mb-12">
              ...
              <p className="text-on-surface-variant text-lg leading-relaxed max-w-md">
                We’ve sent a 6-digit verification code to your registered mobile number. Please enter it below to continue.
              </p>
            </header>

            {/* OTP Form */}
            <form onSubmit={handleVerify} className="space-y-10">
              <div className="flex gap-3 md:gap-4 justify-between max-w-md">
                {[0, 1, 2, 3, 4, 5].map((idx) => (
